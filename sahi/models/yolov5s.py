...
class Yolov5sDetectionModel(DetectionModel):
    ...
    def load_model(self):
        ...
        try:
            ...
            self.category_mapping = {0: "person", 1: "face", 2: "vehicle", 3: "animal"}
            self.category_mapping_inv = {"person": 0, "face": 1, "vehicle": 2, "animal": 3}
